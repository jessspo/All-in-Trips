...
/* <div className="App"> */
  /* <Button className='section-btn' action={() => switchDisplay("main")} text="" />
  {context.apiLoaded === true && 
<>
   <Button className='section-btn' action={() => switchDisplay("weather")} text="Weather" />    
        <Button className='section-btn' action={() => switchDisplay("flights")} text="Flights" />
        <Button className='section-btn' action={() => switchDisplay("hotels")} text="Hotels" />
      </>
      }

{context.currentSection === "main" &&
      <> */
        // <h3>Give us a city name and click <i>Go!</i> 
