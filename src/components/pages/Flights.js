  ...
  const mapFlightOutput = (element, index) => {
    return(
      ...
      <div className="card-flight" key={index}>
        ...
        <p><b><p><i className="fa-solid fa-plane-departure"></i></p> Local Departure:</b> <p>{localTime(element.local_departure)}</p> </p>
        <p><b><p><i className="fa-solid fa-plane-arrival"></i></p>Local Arrival:</b> <p>{localTime(element.local_arrival)}</p> </p>
        <p><b><p><i className="fa-solid fa-clock"></i></p> Flight duration:</b> <p>{secondsToHours(element.duration.total)} hours</p></p> <br/>
        <p><b> <p><i className="fa-solid fa-suitcase"></i></p>Bag price:</b> <p>{Math.round((element.bags_price["1"] * 100) / 100)} &#8364;</p></p>
